...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Image ID="IME" runat="server" src ="images/voto/ENFADADO.png"/>
            <asp:Label ID="PME" runat="server" Text="Label"></asp:Label>
            <asp:Image ID="IE" runat="server" src ="images/voto/NEUTRAL.png" />
            <asp:Label ID="PE" runat="server" Text="Label"></asp:Label>
            <asp:Image ID="IC" runat="server" src ="images/voto/SATISFECHO.png" />
            <asp:Label ID="PC" runat="server" Text="Label"></asp:Label>
            <asp:Image ID="IMC" runat="server" src ="images/voto/CONTENTO.png" />
